<%-- 
    Document   : footer
    Created on : 20-may-2017, 19:08:41
    Author     : rafa
--%>
<%-- 
    Document   : cabecera
    Created on : 20-may-2017, 19:07:29
    Author     : rafa
--%>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6 footerleft ">
                            ...
                            <p>Inventario Albarregas es una aplicacion para hacer inventario específica para el instituro I.E.S Albarregas.</p>
