...
//                alert("mal");
    ...
    $scope.pedirEquipo = function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                Command: toastr["success"]("Se ha podido pedir correctamente!");


            }, error: function (jqXHR, textStatus, errorThrown) {
                Command: toastr["error"]("No se ha podido pedir!");
